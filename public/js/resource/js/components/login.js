...
/* harmony export */ });
/* harmony import */ var _api_authResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api/authResource */ "./resources/js/api/authResource.js");
...
var resource = new _api_authResource__WEBPACK_IMPORTED_MODULE_0__["default"]();
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                alert(1);
                _context.next = 3;
                return resource.login(_this.form).then(function (_ref) {
                  var user = _ref.user,
                      token = _ref.token;
...
/***/ "./resources/js/api/authResource.js":
/*!******************************************!*\
  !*** ./resources/js/api/authResource.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ AuthResource)
/* harmony export */ });
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var AuthResource = /*#__PURE__*/function () {
